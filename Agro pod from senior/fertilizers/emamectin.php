...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-image">
            <img src="fertimages/emamectin.jpg" width="100%" id="mainimg" alt="">

            <div class="small-img-group">

                <div class="small-img-col">
                    <img src="fertimages/emamectin.jpg" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/emamectin2.jpg" width="100%" class="small-img" alt="">
                </div>
        ...
        <div class="single-pro-details">
            ...
            <h4>Emamectin</h4>
            <span>Emamectin Benzoate 5% SG is an insecticide used in Nepal to control a wide range of pests, including caterpillars, thrips, and mites. It is a broad-spectrum insecticide that acts on the insect's nervous system, leading to paralysis and death. <br>

                To use Emamectin Benzoate 5% SG, it is typically mixed with water and applied as a spray to the crops. The recommended dosage and application timings depend on the crop and the specific pest being targeted, and it is important to follow the manufacturer's instructions for application rates and timing. It is also important to wear appropriate protective clothing when handling and applying the insecticide to avoid exposure. <br>

                One of the advantages of using Emamectin Benzoate 5% SG is its effectiveness against a wide range of pests, which can help to protect crops and improve yields. Additionally, it is relatively safe for non-target organisms, such as beneficial insects, and has a low environmental impact. <br>

                However, there are also some disadvantages to using Emamectin Benzoate 5% SG. One potential problem is the development of resistance in pest populations, which can reduce the effectiveness of the insecticide over time. Overuse or misuse of the insecticide can also lead to negative impacts on the environment and human health. <br>

                Overall, the use of Emamectin Benzoate 5% SG can be an effective way to control pests and improve crop yields in Nepal. However, it is important to use the insecticide responsibly and follow recommended guidelines to minimize negative environmental impacts and potential health risks. It is also important to consider alternative pest control methods such as integrated pest management (IPM), which combines different techniques to manage pests in a sustainable and environmentally-friendly manner. </span>
        </div>

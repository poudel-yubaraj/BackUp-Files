...
$result = mysqli_query($conn, "UPDATE `employee` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`gender`='$gender',`contact`='$contact',`dept`='$dept',`degree`='$degree' WHERE id=$id");
...
<ul>
    <li><a href="index1.html">
        ...
        <span id="hvr">Home</span>
    </a></li>
    <li><a href="contact.html" id="hvr"><ion-icon name="call-outline"></ion-icon>Contact Us</a></li>
    <li><a href="elogin.html" id="hvr"><ion-icon name="log-in-outline"></ion-icon>Employee Login</a></li>
    <li><a href="alogin.html" id="hvr"><ion-icon name="log-in-outline"></ion-icon>Admin Login</a></li>
</ul>
</nav>
</div>
</div>
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="row row-space">
                            <!-- <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="birthday" value="">
                        ...
                        <!-- <div class="input-group">
                            <input class="input--style-1" type="number" name="nid" value="">
                        </div>

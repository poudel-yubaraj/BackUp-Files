...
<script>
    function fun(value)
    {
      document.getElementById("iframe1").src="rice/"+value+".php";
    }
</script>
</head>
<body>
...
<iframe src="rice/land.php" frameborder="0" height="90%" width="100%" id="iframe1"></iframe>
</div>
</body>
</html>
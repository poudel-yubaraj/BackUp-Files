...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-image">
            <img src="fertimages/coraplus.jpg" width="100%" id="mainimg" alt="">

            <div class="small-img-group">

                <div class="small-img-col">
                    <img src="fertimages/coraplus.jpg" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/coraplus2.jpg" width="100%" class="small-img" alt="">
                </div>

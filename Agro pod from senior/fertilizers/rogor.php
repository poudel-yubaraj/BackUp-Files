...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-image">
            <img src="fertimages/rogor.webp" width="100%" id="mainimg" alt="">

            <div class="small-img-group">

                <div class="small-img-col">
                    <img src="fertimages/rogor.webp" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/rogor2.jpg" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/rogor3.jfif" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/rogor4.jpg" width="100%" class="small-img" alt="">
                </div>
        ...
        <div class="single-pro-details">
            ...
            <h4>Rogor (Dimethoate 30% EC)</h4>
            <span>Dimethoate 30% EC is a type of insecticide used to control a wide range of pests in Nepal, including aphids, thrips, and mites. It is a contact insecticide, meaning it kills insects on contact rather than being absorbed through the plant tissue. <br>

                To use dimethoate 30% EC, it is typically mixed with water and applied to the crops as a spray. The recommended dosage depends on the crop and the specific pest being targeted, and it is important to follow the manufacturer's instructions for application rates and timing. It is also important to wear appropriate protective clothing when handling and applying the insecticide to avoid exposure. <br>

                One of the advantages of using dimethoate 30% EC is its effectiveness against a wide range of pests, which can help to protect crops and improve yields. Additionally, it is relatively easy to apply and can provide quick results in controlling insect populations. <br>

                However, there are also some disadvantages to using dimethoate 30% EC. One potential problem is its toxicity to non-target organisms such as beneficial insects and birds, which can disrupt the ecosystem and potentially harm human health. Overuse or misuse of the insecticide can also lead to resistance in pest populations, making it less effective over time. <br>

                Overall, the use of dimethoate 30% EC can be an effective way to control pests and improve crop yields in Nepal. However, it is important to use the insecticide responsibly and follow recommended guidelines to minimize negative environmental impacts and potential health risks. It is also important to consider alternative pest control methods such as integrated pest management (IPM), which combines different techniques to manage pests in a sustainable and environmentally-friendly manner. </span>
        </div>

...
<body style="background-image:url(../images/field1.jpg); background-size:cover;">
 <div class="my-3 py-5 position-absolute  start-50 translate-middle-x  text-light" style="background-image:linear-gradient(rgb(66, 49, 138),rgb(54, 65, 224),rgb(25, 155, 230)); height:auto;width:70%;">
  ...
  <div class=" col-sm-8 text-center">
     <span class="h1">Complains</span><br>
     Got a question? We would love to hear from you.<br>
     Send us a message and we wll respond as soon as possible
   </div>
   <div class="col-sm-2 text-center pe-5">
   <!-- <input type="image" src="../images/blank.jpg" alt="Submit" width="48" form="complain"> -->
   <!-- <a href="uploadphoto.php"  > -->
   <a href="#demo" class="btn btn-light" data-bs-toggle="collapse">
    <img src='images/<?php session_start(); if(isset( $_SESSION["complain"] )) echo $_SESSION["complain"]; ?>' class=" img-fluid  d-block" alt="Photo" style="height:auto;width:100%;">  </a>  
  ...
  <input type="submit" value="Upload Image" name="submit">
   ...
   <form action="complainprocess.php" method="post" id="complain">

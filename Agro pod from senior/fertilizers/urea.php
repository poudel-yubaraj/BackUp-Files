...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-image">
            <img src="fertimages/urea3.jpg" width="100%" id="mainimg" alt="">

            <div class="small-img-group">

                <div class="small-img-col">
                    <img src="fertimages/urea3.jpg" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/urea2.webp" width="100%" class="small-img" alt="">
                </div>

                <div class="small-img-col">
                    <img src="fertimages/urea.jpg" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h4>Urea- Nitrogen</h4>
            <span>Nitrogen is an essential nutrient for plants, and in Nepal, it is widely used in the form of fertilizers to improve crop yields. Nitrogen fertilizers can be obtained from both organic and inorganic sources.</span><br>
            <span>One of the most commonly used inorganic nitrogen fertilizers in Nepal is urea. Urea is a white crystalline compound that contains 46% nitrogen by weight. It is easy to transport, store, and apply, and is also relatively inexpensive compared to other nitrogen fertilizers.</span><br>
            <span>To use urea as a fertilizer, it is typically applied to the soil in a granular form, either by broadcasting or banding. Broadcasting involves scattering the granules uniformly over the entire soil surface, while banding involves placing the granules in rows or bands along the plant rows.</span><br>
            <span>One of the advantages of using urea as a fertilizer is its high nitrogen content, which makes it an efficient source of plant nutrition. However, there are also some disadvantages to its use. Urea is a soluble fertilizer, which means it can be easily leached from the soil and into water bodies, causing pollution. Additionally, urea can volatilize into the atmosphere in the form of ammonia gas, which contributes to air pollution and also results in nitrogen loss.</span><br>
            <span>In addition to urea, organic nitrogen fertilizers such as compost and animal manure can also be used in Nepal. Organic fertilizers have the advantage of providing slow-release nitrogen over time, and they can also improve soil health and fertility.</span><br>
            <span>Overall, the use of nitrogen fertilizers in Nepal can improve crop yields and help to feed the growing population. However, it is important to use fertilizers in a responsible and sustainable manner to minimize negative environmental impacts. This can be achieved by using fertilizer at the correct rates, timing, and placement, and by incorporating other management practices such as crop rotation and cover cropping.</span> <br>
        </div>
    ...
    <section id="product1" class="section-p1">
        <h2>Similar Fertilizers in Nepal</h2>
    ...
    <section id="pagination" class="section-p1">
        <a href="#">1</a>
        <a href="fertilizers2.php"><i class="fal fa-long-arrow-alt-right"></i></a>
    </section>
